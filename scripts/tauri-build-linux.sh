...
if /usr/bin/pkg-config --exists webkit2gtk-4.1 javascriptcoregtk-4.1 &&     ! /usr/bin/pkg-config --exists webkit2gtk-4.0 javascriptcoregtk-4.0; then
...
exec corepack pnpm tauri build "$@"
